// Digraph.java: Directed graph implementation in Java
/******************************************************************************
...
public class Digraph {
        ...
        for (int u = 0; u < V; u++) {
            for (int v = 0; v < V; v++) {
                ...
                if (hasEdge(u, v)) {
                    for (int w = 0; w < V; w++) {
                        if (w == v) continue;
                        if (hasEdge(v, w) && !hasEdge(u, w)) { //Mikilvægasta línan imo. Telur ekki með ef u->w er til
                            count++;
                        }
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        /*if (args.length < 4) {
            StdOut.println("Notkun: java Digraph tinyDG.txt u v w");
            return;
        }*/
        ...
        int fjoldi = G.nonTriangles(G.V()); // Kallar á aðferðina á G
        StdOut.println("Fjöldi non-triangle: " + fjoldi);
    }
